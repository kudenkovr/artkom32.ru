...
class ControllerCheckoutConfirm extends Controller {
	...
	public function index() {
		...
		foreach ($data['products'] as &$product) {
			...
			$product['thumb'] = $this->model_tool_image->resize($product['image'], $this->config->get('theme_' . $this->config->get('config_theme') . '_image_cart_width'), $this->config->get('theme_' . $this->config->get('config_theme') . '_image_cart_height'));
			$product['tax'] = 0;
		...
		$order_id = $this->model_checkout_order->addOrderHistory($order_id, 1);
		
		$data['order'] = $this->model_checkout_order->getOrder($order_id);
